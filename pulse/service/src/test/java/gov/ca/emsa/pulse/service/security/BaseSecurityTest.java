...
public class BaseSecurityTest {
	...
	public void setUp(Object controller) throws SQLException, JsonProcessingException {
		 ...
		 * endpointUsedForTest.setExternalId("external"); EndpointType endpointType =
		 * new EndpointType(); endpointType.setId(1L);
		 * endpointUsedForTest.setEndpointType(endpointType); EndpointStatus status =
		 * new EndpointStatus(); status.setId(1L);
