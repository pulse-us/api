...
public class PatientService {
	...
	public @ResponseBody Query requeryPatients(@PathVariable("queryEndpointMapId") Long queryEndpointMapId) throws JsonProcessingException {
		...
		if(jwtUser == null){
			...
			RestTemplate query = new RestTemplate();
			response = query.exchange(brokerUrl + "/requery/" + queryEndpointMapId, HttpMethod.POST, entity, Query.class);
			logger.info("Request sent to broker from services REST.");
		}
