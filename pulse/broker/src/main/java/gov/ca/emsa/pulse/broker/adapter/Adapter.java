...
public interface Adapter {
	...
	public  DocumentQueryResults queryDocuments(CommonUser user, EndpointDTO endpoint, PatientLocationMapDTO patientLocationMap, SAMLInput samlInput) throws UnknownHostException, UnsupportedEncodingException;
	public void retrieveDocumentsContents(CommonUser user, EndpointDTO endpoint, List<DocumentDTO> documents, SAMLInput samlInput, PatientLocationMapDTO patientLocationMap) 
