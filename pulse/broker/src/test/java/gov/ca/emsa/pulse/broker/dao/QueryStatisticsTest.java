...
public class QueryStatisticsTest extends TestCase {
	...
	//TODO: Statistics is broken now that we are pivoting on endpoints
	//and will be addressed in a different ticket
...
//		QueryEndpointMapDTO orgQuery1 = selected.getEndpointMaps().get(0);
//		assertNotNull(orgQuery1.getId());
//		assertTrue(orgQuery1.getId().longValue() > 0);
//		QueryEndpointMapDTO orgQuery2 = selected.getEndpointMaps().get(1);
...
//		orgQuery1 = query.getEndpointMaps().get(0);
//		assertNotNull(orgQuery1.getId());
//		assertTrue(orgQuery1.getId().longValue() > 0);
//		orgQuery2 = query.getEndpointMaps().get(1);
//		assertNotNull(orgQuery2.getId());
//		assertTrue(orgQuery2.getId().longValue() > 0);
//	}
}
